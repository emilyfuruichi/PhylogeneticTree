 ...
 * Read data is stored in an array list of array lists of Points
...
public class FileHandling
{
	 ...
	 * an arraylist of arraylists of Points for the algorithm
	...
	/**
	 * Helper method splits up the given string into an arraylist of Points
	 * @param nextline the string to split up by comma
	 * @return the arraylist of Points in the row
	 */
	private ArrayList<Point> readNextRow(String nextline, int rowCount) 
	{
	    ...
	    try (Scanner rowScanner = new Scanner(nextline)) 
	    {
	        ...
	        while (rowScanner.hasNext()) 
	        {
	        	...
	        	{
	        		//System.out.println(rowCount + " " + colCount + " "+array.get(0).size());
